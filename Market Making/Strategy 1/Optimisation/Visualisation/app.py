...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='Build up graph for Signal Analysis')

    # Add arguments
    parser.add_argument('train_data_path', type=str, help='Path to raw Training Dataset CSV file')
    parser.add_argument('test_data_path', type=str, help='Path to raw Test Data CSV file')
    parser.add_argument('-l', type=int, default=0,
                        help='The number of lags for VOI and OIR determined by the ACF Plot (default=0)')
    parser.add_argument('-d', type=int, default=1,
                        help='The number of delays (in future) for calculating the mid price change (default=1)')
    ...
    # Read the data into a dataframe
    train_data = linear_data(train_data, l=args.l, d=args.d)
    test_data = linear_data(test_data, l=args.l, d=args.d)

    # Call the function with the parsed arguments
    data = backtest_strategy(train_data, test_data, l=args.l)
    make_subplots(data)
